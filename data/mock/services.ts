...
export const services: Service[] = [
  ...
  },
  {
    ...
    seoTitle: "İstanbul Kombi Servisi ve Kalorifer Tesisatı | 724 Tesisatçı",
    seoDescription:
  ...
  },
  {
    ...
    relatedLocalLandingSlugs: ["kagithane-kamerali-tesisat-goruntuleme"],
  ...
  },
  {
    ...
    shortDescription:
      "Doğalgaz tesisatı projelendirme, boru montajı, cihaz bağlantısı ve periyodik güvenlik kontrolü. Standartlara uygun uygulama, sızdırmazlık testi ve dikkatli montaj.",
    longDescription:
      "Doğalgaz tesisatı güvenlik açısından en kritik altyapı sistemlerinden biridir. Hatalı montaj, eskiyen borular veya periyodik kontrolün yapılmaması ciddi güvenlik riskleri oluşturur.\n\n724 Tesisatçı olarak İstanbul genelinde doğalgaz tesisatı projelendirme, boru montajı, kombi-ocak-soba bağlantısı, sızdırmazlık testi ve periyodik güvenlik kontrolü hizmetleri sunuyoruz. Tüm uygulamalar ilgili standartlara uygun şekilde planlanır.\n\nGaz kokusu fark ettiğinizde vanayı kapatıp pencere açın ve acil olarak bizi arayın. Periyodik kontrol süresi dolmuş tesisatlar ceza riski taşır; yıllık kontrol yaptırmanızı öneriyoruz.\n\nİstanbul'da doğalgaz tesisatı projelendirme, montaj ve yıllık periyodik güvenlik kontrolü için ekibimizle iletişime geçin. Sızdırmazlık testi, basınç kontrolü ve standartlara uygun uygulama ile güvenliğinizi destekliyoruz.",
    aboutHighlights: [
      "Standartlara uygun montaj ve bağlantı",
    ...
    heroDescription:
      "Doğalgaz tesisatı projelendirme, montaj, sızdırmazlık testi ve periyodik güvenlik kontrolü. Standartlara uygun ve güvenli uygulama.",
    ...
    relatedLocations: ["istanbul", "kagithane"],
    seoTitle: "İstanbul Doğalgaz Tesisatı Hizmeti | 724 Tesisatçı",
    seoDescription: "İstanbul doğalgaz tesisatı projelendirme, montaj ve periyodik kontrol. Standartlara uygun uygulama, sızdırmazlık testi, güvenli montaj.",
  ...
  },
  {
    ...
    seoTitle: "İstanbul Gömme Rezervuar Tamiri ve Montaj | 724 Tesisatçı",
  ...
  },
  {
    ...
    seoTitle: "İstanbul Batarya ve Musluk Montaj Hizmeti | 724 Tesisatçı",
