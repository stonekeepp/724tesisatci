...
export class MockBlogRepository implements IBlogRepository {
  ...
  async create(data: BlogFormInput) {
    ...
    const post: BlogPost = {
      ...
      localFocus: data.localFocus || undefined,
      editorialReviewedBy: data.editorialReviewedBy || undefined,
      editorialReviewedAt: data.editorialReviewedAt || undefined,
      editorialNote: data.editorialNote || undefined,
